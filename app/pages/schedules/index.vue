              ...
              >
                ...
                >
                  <div class="font-medium">
                    {{ getSchedule(day.value, period)?.subject?.subjectName }}
                  </div>
                  <div class="text-muted">
                    {{ getSchedule(day.value, period)?.teacher?.firstName }}
                  </div>
                  <div class="text-muted">
                    {{ getSchedule(day.value, period)?.startTime }} -
                    {{ getSchedule(day.value, period)?.endTime }}
                  </div>
                </div>
