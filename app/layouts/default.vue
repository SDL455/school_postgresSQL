    ...
    <aside class="app-sidebar" :class="{ collapsed: isSidebarCollapsed }">
      <div class="app-sidebar-header">
        <div class="app-sidebar-logo">
          ...
          <span v-if="!isSidebarCollapsed" class="app-sidebar-logo-text">ໂຮງຮຽນ SMS</span>
        </div>
      </div>
      ...
      <div class="sidebar-footer" style="position: absolute; bottom: 0; left: 0; right: 0; padding: 1rem;">
        <button 
          class="app-sidebar-menu-link" 
      ...
      <header class="app-header">
        <div class="app-header-left">
          <button class="btn btn-ghost" @click="toggleSidebar">
            <Icon :name="isSidebarCollapsed ? 'mdi:menu' : 'mdi:menu-open'" size="24" />
          </button>
        ...
        <div class="app-header-right">
          <div class="dropdown">
            <button class="btn btn-ghost flex items-center gap-2" @click="toggleDropdown">
            ...
            <div v-if="isDropdownOpen" class="dropdown-menu" style="opacity: 1; visibility: visible; transform: translateY(0);">
